...
public class WxPayNotifyModel {
	...
	public String toString() {
		return "WxPayNotifyModel [id=" + id + ", appid=" + appid
				+ ", bankType=" + bankType + ", cashFee=" + cashFee
				+ ", feeType=" + feeType + ", isSubscribe=" + isSubscribe
				+ ", mchId=" + mchId + ", nonceStr=" + nonceStr + ", openid="
				+ openid + ", outTradeNo=" + outTradeNo + ", resultCode="
				+ resultCode + ", returnCode=" + returnCode + ", sign=" + sign
